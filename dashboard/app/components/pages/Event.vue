...
const PRESET_TSUNAMI: PresetEntry[] = [
  {
    instrument: 'RS03AXBS-MJ03A-06-PRESTA301',
    parameter: 'seafloor_pressure',
    overlay: 'none',
    timespan: 'week',
  },
  {
    instrument: 'RS01SLBS-MJ01A-06-PRESTA101',
    parameter: 'seafloor_pressure',
    overlay: 'none',
    timespan: 'week',
  },
  {
    instrument: 'RS01SUM1-LJ01B-09-PRESTB102',
    parameter: 'seafloor_pressure',
    overlay: 'none',
    timespan: 'week',
  },
  ...
  {
    instrument: 'RS03INT2-MJ03D-06-BOTPTA303',
    parameter: 'seafloor_uplift_5m',
    overlay: 'none',
    timespan: 'week',
  },
