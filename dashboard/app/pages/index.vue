    ...
    <div class="flex flex-col h-full items-center justify-center m-auto pt-10 space-y-8">
      <div>
        ...
        <div class="flex flex-row justify-center space-x-2">
          <img alt="UW Oceanography logo" class="h-[100px]" src="@/assets/oceanographyUW.png" />
          <img alt="OOI logo" class="h-[100px]" src="@/assets/ooilogo.png" />
          <img alt="NSF logo" class="h-[100px]" src="@/assets/NSF.png" />
        </div>
      </div>
    </div>
  </div>
